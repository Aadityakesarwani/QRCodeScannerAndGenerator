...
public class GenerateCodeTask extends AsyncTask<String, Void, Bitmap> {
    ...
    public GenerateCodeTask(ImageView imageView,
                            ProgressBar progressBar,
                            int imageWidth, int imageHeight, BarcodeFormat format, Map<ResultMetadataType, Object> metadata) {
    ...
    protected Bitmap doInBackground(String... strings) {
        if (strings != null && strings[0] != null) {
            return Utilss.generateCode(strings[0], format, imageWidth, imageHeight, null, metadata);
        } else {
            return null;
        }
    }
