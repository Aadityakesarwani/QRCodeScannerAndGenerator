...
public class Code93 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "CODE_93" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

        code93  = findViewById(R.id.code93);
...
//
    ...
    private void generateqr() throws WriterException {
        result = code93 .getText().toString().toUpperCase();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.CODE_93,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(code93 .getApplicationWindowToken(),0);
        ...
        findViewById(R.id.outputlayout).setVisibility(View.VISIBLE);
            ...
            e.printStackTrace();
            Toast.makeText(this, "cap char", Toast.LENGTH_SHORT).show();
        }
    }
