...
public class Datamatrix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "DATA_MATRIX" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

        datamatrix  = findViewById(R.id.datamatrix);
...
//
    ...
    private void generateqr() throws WriterException {
        result = datamatrix .getText().toString();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.DATA_MATRIX,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(datamatrix.getApplicationWindowToken(),0);
