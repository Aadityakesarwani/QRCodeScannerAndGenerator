...
public class Itf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "ITF" + "</font>"));
...
//
    ...
    private void generateqr() throws WriterException {
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.ITF,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(itf.getApplicationWindowToken(),0);
