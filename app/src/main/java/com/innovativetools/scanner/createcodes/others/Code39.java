...
public class Code39 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_code39);
                ...
                Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "CODE_39" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

        code39  = findViewById(R.id.code39);
...
//
    ...
    private void generateqr() throws WriterException {
        result = code39 .getText().toString().toUpperCase();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.CODE_39,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(code39.getApplicationWindowToken(),0);
