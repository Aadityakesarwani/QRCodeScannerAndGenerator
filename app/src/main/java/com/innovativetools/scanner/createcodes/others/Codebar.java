...
public class Codebar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "CODABAR" + "</font>"));
...
//
    ...
    private void generateqr() throws WriterException {
        result = codebar.getText().toString();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.CODABAR,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(codebar.getApplicationWindowToken(),0);
