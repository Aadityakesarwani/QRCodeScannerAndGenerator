...
public class Aztech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aztech);

        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "AZTECH" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

        aztech   = findViewById(R.id.aztech);
...
//
    ...
    private void generateqr() throws WriterException {
        result = aztech .getText().toString();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.AZTEC,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(aztech.getApplicationWindowToken(),0);
