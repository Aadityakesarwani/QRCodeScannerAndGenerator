...
public class Ean13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "EAN_13" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

            ean13 = findViewById(R.id.ean13);
...
//
    ...
    private void generateqr() throws WriterException {
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.EAN_13,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(ean13.getApplicationWindowToken(),0);
