...
public class Pdf417 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "PDF_417" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

        pdf417 = findViewById(R.id.pdf417);
...
//
    ...
    private void generateqr() throws WriterException {
        result = pdf417.getText().toString();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.PDF_417,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(pdf417.getApplicationWindowToken(),0);
