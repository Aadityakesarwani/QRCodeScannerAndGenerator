...
public class Ean8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "EAN_8" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

            ean8 = findViewById(R.id.ean8);
...
//
    ...
    private void generateqr() throws WriterException {
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.EAN_8,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(ean8.getApplicationWindowToken(),0);
