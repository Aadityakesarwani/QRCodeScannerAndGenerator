...
public class Code128 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color=\"#ffffff\">" + "CODE_128" + "</font>"));
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);

        code128 = findViewById(R.id.code128);
...
//
    ...
    private void generateqr() throws WriterException {
        result = code128.getText().toString();
        ...
        BitMatrix matrix = writer.encode(result, BarcodeFormat.CODE_128,350,350);
...
//
        ...
        inputMethodManager.hideSoftInputFromWindow(code128.getApplicationWindowToken(),0);
